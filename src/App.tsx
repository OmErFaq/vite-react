...
const SmartPlusLogo = () => (
  <svg viewBox="0 0 140 38" style={{ height: 32, display: "block" }}>
    <text x="0" y="28" fontFamily="'Segoe UI', system-ui, sans-serif" fontSize="28" fontWeight="800" fill="#031c2e" letterSpacing="-0.5">
