...
interface Guest {
  ...
  table: string; side: string; entrance: string; status: string;
  dynamic?: boolean;
  docId?: string; 
}

const BASE_GUESTS: Guest[] = [
  {id:"001",name:"Mohammed AlSultan",role:"CEO",table:"R4",side:"Right",entrance:"B",status:"confirmed"},
  {id:"002",name:"Ahmed Elgendi",role:"COO",table:"R4",side:"Right",entrance:"B",status:"confirmed"},
  {id:"003",name:"Mohammed Samir Alsysy",role:"CFO",table:"R4",side:"Right",entrance:"B",status:"confirmed"},
  {id:"004",name:"Omer Farooq",role:"Marketing / Organizer",table:"R4",side:"Right",entrance:"B",status:"confirmed"},
  {id:"005",name:"Asad Li",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"006",name:"Alaa Zaghloul",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"007",name:"Junaid",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"008",name:"Omar Alharahsheh",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"009",name:"Sulieman",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"010",name:"Jeremy Che",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"confirmed"},
  {id:"011",name:"Abdelrahman Ashawy",role:"Operations Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"012",name:"Jumah",role:"DPP Sales Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"013",name:"Zeeshan Yaqoob",role:"Pre-Sales Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"014",name:"Raees",role:"Retail Sales Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"015",name:"Gamal Yasser",role:"DPP Sales",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"016",name:"Oliver",role:"Projects & Tech Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"017",name:"Nawaf",role:"Projects Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"018",name:"Bader",role:"Accounts Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"019",name:"Mohamed Elmugtaba",role:"SmartPlus",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"020",name:"Wadsary",role:"SmartPlus",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"021",name:"Sahil Noor",role:"Norden Brand Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"022",name:"Hussein Morgan",role:"Ezviz Brand Manager",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"023",name:"Mohammed Sohel",role:"Retail Sales",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"024",name:"Yosry",role:"Retail Sales",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"025",name:"Ahmad Ragga",role:"ISAMA Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"026",name:"Hamza Taha",role:"BRC Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"027",name:"Tamer Shaban",role:"Saudi GEO",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"028",name:"Abdulrahman Hussein",role:"Star Care Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"029",name:"Nhec Inao",role:"NCR Solutions",table:"L7",side:"Left",entrance:"A",status:"confirmed"},
  {id:"030",name:"Laith Alwahidi",role:"SPECTRA INTL",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"031",name:"Moayad Ali",role:"Projects Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"032",name:"Mamdouh Mustafa",role:"Projects Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"033",name:"Mohammed Bakry",role:"Projects Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"034",name:"Ahmed Essam",role:"Projects Team",table:"R5",side:"Right",entrance:"B",status:"confirmed"},
  {id:"035",name:"Aman Zia",role:"Creation Source",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"036",name:"Mahmoud Hamdy",role:"Saudi Etqaan",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"037",name:"Wael",role:"MIS",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"038",name:"Ahmed Younes",role:"Techflipp",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"039",name:"Mahdi",role:"Tasheel",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"040",name:"Ahmed Alsyse",role:"AL Matbouli",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"041",name:"Yasir",role:"Warehouse Team",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"042",name:"Kazi Riyad",role:"Warehouse Team",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"043",name:"Frank",role:"Warehouse Coordinator",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"044",name:"Mahmoud Tarek",role:"Logistics Team",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"045",name:"Usman",role:"Logistics Team",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"046",name:"Kamal",role:"Office",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"047",name:"Elbehery Mohammed",role:"IT Team",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"048",name:"Mohamad Al-Ghool",role:"Signal Control",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"049",name:"Osaid Abudiyah",role:"XYZ Dimensions",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"050",name:"Husnain",role:"SPECTRA INTL",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"051",name:"Sinn",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"052",name:"Bensyl",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"053",name:"Carlo",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"054",name:"Renan",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"055",name:"Thomson",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"056",name:"Angelito",role:"Technician",table:"R6",side:"Right",entrance:"B",status:"confirmed"},
  {id:"057",name:"Jerome Celis Ravelo",role:"bits arabia",table:"L7",side:"Left",entrance:"A",status:"confirmed"},
  {id:"058",name:"Esteban Agana",role:"Future Digital United",table:"L7",side:"Left",entrance:"A",status:"confirmed"},
  {id:"059",name:"Vergil Garcia",role:"Future Digital United",table:"L7",side:"Left",entrance:"A",status:"confirmed"},
  {id:"060",name:"Imran",role:"TeleNoc",table:"L6",side:"Left",entrance:"A",status:"confirmed"},
  {id:"061",name:"Reema",role:"SmartPlus",table:"R3",side:"Right",entrance:"B",status:"confirmed"},
  {id:"062",name:"Maha",role:"HR Head",table:"R3",side:"Right",entrance:"B",status:"confirmed"},
  {id:"063",name:"Abed El Wadoud",role:"Abniya",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"064",name:"Mohammed Abdo",role:"Saudi Etqaan",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"065",name:"Mohammed Alshik",role:"Narssess Hotel",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"066",name:"Mohamed El Fakharany",role:"Saudi GEO",table:"L5",side:"Left",entrance:"A",status:"tentative"},
  {id:"067",name:"Ahmad Bashr",role:"BRC Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"068",name:"Mohammed Ghamrawy",role:"PDM",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"069",name:"Waleed Banat",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"tentative"},
  {id:"070",name:"Hosny Elsayed",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"tentative"},
  {id:"071",name:"Ahmed Al Absi",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"tentative"},
  {id:"072",name:"Nawaf Alotaibi",role:"Hikvision",table:"R1",side:"Right",entrance:"B",status:"tentative"},
  {id:"073",name:"Mosab Arar",role:"Hikvision",table:"R2",side:"Right",entrance:"B",status:"tentative"},
  {id:"074",name:"Mosab Elkheiri",role:"Hikvision",table:"R2",side:"Right",entrance:"B",status:"tentative"},
  {id:"075",name:"Ismail Issa",role:"Hikvision",table:"R2",side:"Right",entrance:"B",status:"tentative"},
  {id:"076",name:"Saleh Rifai",role:"Hikvision",table:"R2",side:"Right",entrance:"B",status:"tentative"},
  {id:"077",name:"Fadi",role:"Anazeem",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"078",name:"Moyasere",role:"Dar Delta",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"079",name:"Mohamed Agmi",role:"Anazeem",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"080",name:"Hazem",role:"Anazeem",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"081",name:"Saudi Al Atibi",role:"Dar Delta",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"082",name:"Yousef",role:"Saudi Sensor",table:"R7",side:"Right",entrance:"B",status:"tentative"},
  {id:"083",name:"Fahed",role:"Digitums",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"084",name:"Saeed",role:"Digitums",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"085",name:"Tarek",role:"Zaid Alhuusien",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"086",name:"M. Fawzy",role:"Zaid Alhuusien",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"087",name:"Mohamed Attwan",role:"Basco",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"088",name:"Mostafa",role:"Basco",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"089",name:"Mazher",role:"Tasheel",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"090",name:"Ahmed Morsy",role:"Toptech",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"091",name:"Ahmed Rabieh",role:"Mastry House",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"092",name:"Abdelaziz",role:"Techflipp",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"093",name:"Iqbal Younes",role:"Creation Source",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"094",name:"Mohammed Abdalla",role:"Amnco",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"095",name:"Omar Hamad",role:"Benya",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"096",name:"Yousif Algoth",role:"SecureTech",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"097",name:"Abdullah Abushaqra",role:"XYZ Dimensions",table:"R8",side:"Right",entrance:"B",status:"tentative"},
  {id:"098",name:"Hifzul Patel",role:"Hikvision",table:"R2",side:"Right",entrance:"B",status:"tentative"},
  {id:"099",name:"Majed Mohammed",role:"Gulf Fields Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"100",name:"Osama Ibrahim",role:"Gulf Fields Company",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"101",name:"Ibrahim",role:"Saudi Etqaan",table:"L5",side:"Left",entrance:"A",status:"confirmed"},
  {id:"102",name:"Najhi Najmul",role:"مؤسسة عنوان الحلول التجارية",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"103",name:"Shihab",role:"مؤسسة اساليب الامان للتجاره",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"104",name:"Abdullah",role:"شركة وايدر يونيفرسال فور تريدينغ",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
  {id:"105",name:"Delower",role:"شركة وايدر يونيفرسال فور تريدينغ",table:"L8",side:"Left",entrance:"A",status:"confirmed"},
];
  ...
  const handleSave = async () => {
    ...
    try {
      await setDoc(doc(GUESTS_COL, firebaseDocId), {
        ...
        table: form.table.trim().toUpperCase(),
        side: form.side,
      ...
      setTimeout(() => {
        ...
        else setForm({ name:"", role:"", table:"L1", status:"confirmed", entrance:"A", side:"Left" });
      }, 1500);
    ...
    <div style={{position:"fixed",inset:0,zIndex:1000,background:"rgba(0,0,0,0.85)",
      ...
      <div style={{background:GLASS,backdropFilter:"blur(24px)",borderRadius:22,
        ...
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <div>
            <label style={labelStyle}>Table (e.g. L4 or R2)</label>
            <input value={form.table} onChange={e=>setForm({...form,table:e.target.value})}
              type="text" placeholder="L1" style={inputStyle}/>
          </div>
  ...
  return (
    <div style={{minHeight:"100vh",width:"100%",
      ...
      <div style={{position:"relative",zIndex:1,maxWidth:460,margin:"0 auto",padding:"0 16px 60px"}}>
        ...
        <div style={{display:"flex",justifyContent:"flex-end",paddingTop:30,marginBottom:18}}>
          ...
          return (
            <div key={guest.id} style={{background:checked?"rgba(6,52,36,0.7)":GLASS,backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",borderRadius:18,marginBottom:14,border:`1px solid ${checked?"rgba(30,200,100,0.35)":tentative?"rgba(240,200,60,0.28)":BORDER}`,padding:"20px 18px",boxShadow:"0 4px 28px rgba(0,0,0,0.3)",transition:"all 0.3s"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:14}}>
                {([
                  {label:"Table",val:guest.table,color:"#f0c84a",large:true,circle:false},
